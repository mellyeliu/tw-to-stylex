...
export default function App() {
  ...
  return <div {..._stylex.props(_styles.base, _styles[selectedStyle])}>
      <div {..._stylex.props(_styles.container)}>
        ...
        duration: 0.5
          ...
          <h1 {..._stylex.props(_styles.title)}>
            Pixel Doodle Studio
          </h1>
          <p {..._stylex.props(_styles.subtitle)}>
            Create amazing pixel art with style ✨
          </p>
        </motion.div>

        <div {..._stylex.props(_styles.grid)}>
          <motion.div initial={{
          opacity: 0,
          scale: 0.9
        }} animate={{
...
const _styles = _stylex.create({
  ...
  grid: {
    ...
    gridTemplateColumns: {
      ...
      "@media (min-width: 1024px)": "1fr auto"
    },
    gap: "1.5rem"
  },
  column: {
