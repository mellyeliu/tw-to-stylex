...
function DashboardIcon() {
  return <svg {...stylex.props(styles.icon)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const Sidebar: React.FC<SidebarProps> = ({ onNavigate }) => {
  ...
  return (
    <aside {...stylex.props(styles.sidebar, isCollapsed ? styles.collapsed : styles.expanded)}>
      <div {...stylex.props(styles.header)}>
        {!isCollapsed && <span {...stylex.props(styles.logo)}>Dashboard</span>}
        <button onClick={() => setIsCollapsed(!isCollapsed)} {...stylex.props(styles.toggleButton)}>
