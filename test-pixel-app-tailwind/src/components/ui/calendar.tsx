...
function Calendar({
  ...
  return <DayPicker showOutsideDays={showOutsideDays} className={[_styles.$1, className]} classNames={{
    ...
    IconLeft: ({
      className,
      ...props
    }) => <ChevronLeft className={[_styles.$2, className]} {...props} />,
    IconRight: ({
      className,
      ...props
    }) => <ChevronRight className={[_styles.$2, className]} {...props} />
  }} {...props} />;
}
export { Calendar };
